...
**아키텍처 설계 → 개발 → 배포 → 운영 최적화**까지  
전체 시스템 라이프사이클 경험이 있습니다.
...
- SaaS 플랫폼 및 분석 대시보드 개발
- 확장 가능한 REST API 및 백엔드 시스템 설계
- 운영 환경 DB 쿼리 성능 최적화
...
- RDBMS **쿼리 옵티마이저 컴포넌트 개발**
- **통계 수집 및 SQL 튜닝 기능 구현**
- 엔터프라이즈 고객 대상 **SQL 성능 최적화 지원**
...
<p align="right"><a href="#-한국어">맨 위로 ↑</a></p>
